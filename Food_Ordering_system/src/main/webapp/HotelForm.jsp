...
<body>
    <div>
        ...
        <div class="inputopt">
            <form:form action="savehotel" modelAttribute="hotelobj" id="hotelForm" >
                <form:input path="name" id="name" placeholder="Enter Hotel Name" required="required" />
                <br>
                ...
                <br>
                <form:input path="m_number" id="m_number" placeholder="Enter Mobile Number" required="required" type="number"/>
                <br>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(event) {
                ...
                const mobileNumberInput = document.getElementById("m_number");
